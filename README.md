...
## API Documentation
Once the system is running, access the interactive Swagger UI to explore endpoints, schemas, and example requests: [http://localhost:10000/api/v1/docs/](http://localhost:10000/api/v1/docs/) 
